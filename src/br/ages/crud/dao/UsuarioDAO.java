...
public class UsuarioDAO {
	...
	public Usuario validarUsuario(Usuario usuarioDTO) throws PersistenciaException {
		...
		try {
			...
			if (resultset.next()) {
				...
				usuario.setPerfilAcesso(PerfilAcessoEnum.valueOf(resultset.getString("PERFIL_ACESSO")));
				usuario.setEmail(resultset.getString("EMAIL"));
				usuario.setUsuario(resultset.getString("USUARIO"));
				usuario.setSenha(resultset.getString("SENHA"));
				usuario.setStatusUsuario(StatusUsuarioEnum.valueOf(resultset.getString("STATUS_USUARIO")));
			} else
				usuario = null;
	...
	public List<Usuario> listarUsuarios() throws PersistenciaException, SQLException {
		...
		try {
			...
			while (resultset.next()) {
				...
				dto.setPerfilAcesso(PerfilAcessoEnum.valueOf(resultset.getString("PERFIL_ACESSO")));
				dto.setStatusUsuario(StatusUsuarioEnum.valueOf(resultset.getString("STATUS_USUARIO")));
	...
	public int verificaUsuarioProjeto(Integer idUsuario) throws PersistenciaException, SQLException {
		...
		try {
			...
			StringBuilder sql = new StringBuilder();
			sql.append("select id_usuario from tb_usuario where id_usuario = ?;");
	...
	public List<Usuario> listarUsuariosReponsaveis() throws PersistenciaException, SQLException {
		...
		try {
			...
			//XXX Alterar a tabela TB_TIPO_USUARIO para ter um flag marcando se o tipo � respons�vel
